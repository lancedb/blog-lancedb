...
{{< code language="python" source="examples/py/embedding.py" id="embedding" />}}
{{< code language="typescript" source="examples/ts/embedding.ts" id="embedding" />}}
{{< code language="rust" source="examples/rs/embedding.rs" id="embedding" />}}
