...
Note that for Azure, storage credentials must be configured. See [Azure Blob Storage](#azure-blob-storage) for more details.
...
{{< admonition info "Storage option casing" >}}
