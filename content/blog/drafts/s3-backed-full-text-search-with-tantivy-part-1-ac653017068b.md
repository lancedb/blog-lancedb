...
![](https://miro.medium.com/v2/resize:fit:770/1xcj41cmBTBz0QaT9h3e6loQ.png)
Since there is only one `meta.json` file, the following could happen
![](https://miro.medium.com/v2/resize:fit:770/1xw45DjlH0YzqnrITLLueRyg.png)
...
![](https://miro.medium.com/v2/resize:fit:770/1xReeLhxHyF4zWF1phSvl4xQ.png)
## Read Path

![](https://miro.medium.com/v2/resize:fit:770/1xRuOecvFfhr7dvSh7vD9gAg.png)
...
![](https://miro.medium.com/v2/resize:fit:770/1xgw3qLodnW_VwK8wrvAc-1A.png)
