...
This structure resembles that of the [Apache Software Foundation](https://www.apache.org/), and what we described above is very much in line with [the Apache Way](https://www.apache.org/theapacheway/) and "Community over Code" spirit - which is not surprising if you check out the backgrounds of Lance maintainers and PMC members 😉. 
